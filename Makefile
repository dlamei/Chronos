...
Chronos: $(SRC_DIR)/main.cpp $(SRC_DIR)/lexer.cpp $(SRC_DIR)/Parser.cpp $(SRC_DIR)/Compiler.cpp $(BIN_DIR)/64chlib.o
	mkdir -p $(BIN_DIR)
	g++ $(SRC_DIR)/main.cpp $(SRC_DIR)/lexer.cpp $(SRC_DIR)/Parser.cpp $(SRC_DIR)/Compiler.cpp $(BIN_DIR)/64chlib.o -o $(BIN_DIR)/Chronos
